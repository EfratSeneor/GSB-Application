...
<?php//elements non forfaitises?>
   ...
   <div class="panel panel-info1" >
           ...
           foreach ($lesFraisHorsForfait as $unFraisHorsForfait) {
               ...
               <tr>
                   ...
                   <td><button class="btn btn-success" type="edit" name="corriger" value="corriger">Corriger</button>
                       <button class="btn btn-danger" type="reset">Reinitialiser</button>
                       <button class="btn btn-success" type="edit" name="reporter" value="reporter">Reporter</button>
                   </tr>
               <?php
           }
           ?>
    ...
    <input type="hidden" name="lstMois" id="idMois" size="10" value="<?php echo $moisASelectionner?>" class="form-control"/>
    <input type="hidden" name="lstVisiteurs" id="idVisiteur" size="10" value="<?php echo $visiteursASelectionner ?>" class="form-control"/>
    Nombre de justificatifs:<input type="text" name="nbJust" id="nbJust" size="1" value="<?php echo $nbJustificatifs?>" /><br><br>
