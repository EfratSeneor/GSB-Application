                    ...
                    <div class="col-md-8">
                        <ul class="nav nav-pills-c pull-right" role="tablist">
                            ...
                            <li <?php if ($uc == 'validerFrais') { ?>class="active"<?php } ?>>
                                <a style="color:orange" href="index.php?uc=validerFrais&action=selectionnerVisiteur">
                                    <span class="glyphicon glyphicon-ok"></span>
                                    Valider fiche de frais
                                </a>
                            </li>
                            <li <?php if ($uc == 'etatFrais') { ?>class="active"<?php } ?>>
                                <a style="color:orange" href="index.php?uc=suiviPaiement&action=selectionnerVM">
